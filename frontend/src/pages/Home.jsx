...
const Home = () => {
    ...
    return (
        <div className="flex flex-col items-center">
            {/* Hero Section */}
            <section className="w-full bg-[url('https://images.unsplash.com/photo-1585747860715-2ba37e788b70?ixlib=rb-4.0.3')] bg-cover bg-center h-[500px] flex items-center justify-center relative">
